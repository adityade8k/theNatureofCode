...
export const CANVAS_INTRO_CONFIG = {
  ...
  body: {
    ...
    links: [
      ...
      {
        text: "repository",
        href: "https://github.com/adityade8k/BranchNotebook"
      }
    ],
    x: -225,
    y: -20,
